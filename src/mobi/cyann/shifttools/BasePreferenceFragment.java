...
import mobi.cyann.shifttools.preference.BasePreference;
import mobi.cyann.shifttools.preference.RemovablePreferenceCategory;
...
public class BasePreferenceFragment extends PreferenceListFragment implements OnPreferenceAttachedListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		getActivity().registerReceiver(reloadListener, new IntentFilter("mobi.cyann.shifttools.RELOAD"));
	}
