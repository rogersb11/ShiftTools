...
public class ObserverService extends Service {
	private final static String LOG_TAG = "ShiftTools.ObserverService";
	...
	public static void startService(Context context, boolean forced) {
		...
		boolean startService = preferences.getBoolean(context.getString(R.string.key_shifttools_service), false);
